...
def format_epoch_state(result: QueryStateResult, fmt: str) -> str:
...
def format_start_result(workflow_id: str, run_id: str, fmt: str) -> str:
...
def format_signal_result(success: bool, fmt: str) -> str:
