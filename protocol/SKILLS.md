...
All `/aura:*` slash commands, organized by role and phase. Each command is a markdown file in the `commands/` directory, installed to `~/.claude/commands/` via the Home Manager module.
